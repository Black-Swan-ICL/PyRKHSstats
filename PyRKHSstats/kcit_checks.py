...
if __name__ == '__main__':
    ...
    # Low-dimensional where CI holds true
    data_x = laplace.rvs(loc=0.5, scale=1, size=N).reshape(-1, 1)
    data_y = laplace.rvs(loc=0, scale=1, size=N).reshape(-1, 1)
    data_z = data_x + data_y + laplace.rvs(loc=0, scale=1, size=N).reshape(-1, 1)
